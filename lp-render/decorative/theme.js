...
/* hero */
.lp-header{position:relative;overflow:hidden;margin:0;padding:34px 40px 30px;border:0;border-radius:0 0 30px 30px;
  background:linear-gradient(125deg,#3a63ff 0%,#6a4bff 52%,#a24bff 100%);color:#fff}
.lp-header h1{margin:0 0 6px;font-size:38px;font-weight:800;line-height:1.08;color:#fff;text-shadow:0 2px 10px rgba(0,0,0,.18)}
.lp-header .sub{font-size:16px;opacity:.95;font-weight:600;color:#fff;margin-top:2px}
.lp-header .meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}
...
.s-head{display:flex;align-items:center;gap:12px;margin:0 0 12px}
...
.panel{background:#fff;border:1px solid var(--line);border-radius:20px;padding:18px 20px;box-shadow:0 10px 26px rgba(40,60,120,.08)}
...
.d-img .cap{padding:9px 13px;font-size:13px;font-weight:700;color:var(--ink)}
`;
