...
const LABELS = {
  en: {
    ...
    resources: 'Resources', targetWords: 'Target words', teacherNote: 'Teacher note', cfu: 'Check for understanding', struggling: 'For struggling students', advanced: 'For advanced students', exitTicket: 'Exit ticket', homework: 'Homework', photoCredits: 'Photo credits',
  ...
  ur: {
    ...
    resources: 'وسائل', targetWords: 'ہدف الفاظ', teacherNote: 'اُستاد کے لیے نوٹ', cfu: 'سمجھ کی جانچ', struggling: 'کمزور طلبہ کے لیے', advanced: 'ہونہار طلبہ کے لیے', exitTicket: 'اخراجی ٹکٹ', homework: 'ہوم ورک', photoCredits: 'تصاویر کے حوالہ جات',
  ...
  sd: {
    ...
    resources: 'وسيلا', targetWords: 'خاص لفظ', teacherNote: 'استاد لاءِ نوٽ', cfu: 'سمجهه جي جانچ', struggling: 'ڪمزور شاگردن لاءِ', advanced: 'هوشيار شاگردن لاءِ', exitTicket: 'نڪرڻ وارو ٽڪيٽ', homework: 'گهر جو ڪم', photoCredits: 'تصويرن جا حوالا',
  ...
  ar: {
    ...
    resources: 'الموارد', targetWords: 'الكلمات المستهدفة', teacherNote: 'ملاحظة للمعلم', cfu: 'التحقق من الفهم', struggling: 'للطلاب المتعثرين', advanced: 'للطلاب المتقدمين', exitTicket: 'بطاقة الخروج', homework: 'الواجب المنزلي', photoCredits: 'حقوق الصور',
