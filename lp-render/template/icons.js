...
const BODY = {
  ...
  family: `<circle cx="16" cy="18" r="8" fill="#9b6bff"/><path d="M8 50c0-9 6-13 12-13s12 4 12 13z" fill="#9b6bff"/><circle cx="48" cy="18" r="8" fill="#5ec6ff"/><path d="M32 50c0-9 6-13 12-13s12 4 12 13z" fill="#5ec6ff"/><circle cx="32" cy="34" r="6" fill="#ff6f61"/><path d="M23 54c0-6 4-9 9-9s9 3 9 9z" fill="#ff6f61"/>`,
