...
function renderReport(results) {
  ...
  const cards = results
    ...
    .map(
      (r) =>
        `<figure style="margin:0"><figcaption>${esc(r.model)} · ${esc(r.item)}</figcaption>` +
  ...
  return (
    ...
    `<thead><tr><th>Model</th><th>Item</th><th>Status</th><th>Cost</th><th>Latency</th><th>Attempts</th><th>Error / Notes</th></tr></thead>` +
